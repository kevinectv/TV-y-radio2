...
target_label = """                                val displayLabel = when (tab) {
                                    AppTab.HOME -> "Inicio"
...
replacement_label = """                                val displayLabel = when (tab) {
                                    AppTab.HOME -> "Inicio"
                                    AppTab.WATCHLIST -> "Mi lista"
                                    AppTab.MOVIES -> "Películas"
                                    AppTab.SERIES -> "Series"
...
if target_outer in content and target_label in content and target_right in content:
    ...
    if target_label not in content: print("label missing")
